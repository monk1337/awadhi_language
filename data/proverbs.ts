...
/**
 * Awadhi proverbs from Part 6 of the master report.
 * Thematic patterns: patience, courtesy, contentment, karmic justice,
 * suspicion of distant power, appreciation of refinement, dark humor about survival.
 */
export const proverbs: Proverb[] = [
  {
    ...
    literal: "After you!",
    meaning:
      "Defining Lucknowi/Awadhi phrase. Legendary for creating infinite loops of politeness. Traces to Awadhi etiquette culture of tehzeeb.",
    context: "courtesy",
  },
  {
  ...
  {
    awadhi: "Ghar ka bhedi, Lanka dhaye",
    literal: "The insider of the house brings down Lanka.",
    meaning: "Warning against betrayal from within, using the Ramayana as metaphor.",
    context: "wisdom",
  },
  {
  ...
  {
    awadhi: "Aamdani atthanni, kharcha rupaiya",
    literal: "Income is half-rupee, expense is full rupee.",
    meaning: "The farmer's reality: perpetually living beyond means.",
    context: "agrarian",
  },
  {
  ...
  {
    awadhi: "Bandar kya jaane adrak ka swaad",
    literal: "What does a monkey know of ginger's taste?",
    meaning: "About those who cannot appreciate refined things.",
    context: "refinement",
  },
  {
  ...
  {
    awadhi: "Ab pachtaye hot kya jab chidiya chug gayi khet",
    literal: "What's the use of repenting when the birds have eaten the crop?",
    meaning: "Regret is useless after the damage is done.",
    context: "agrarian",
  },
  {
    awadhi: "Boond boond se sagar bharta hai",
    literal: "Drop by drop, the ocean fills.",
    meaning: "Patience and persistence lead to great outcomes.",
  ...
  {
    awadhi: "Sukh ke sab saathi, dukh mein na koi",
    literal: "Everyone is companion in happiness, none in sorrow.",
    meaning: "Cynical wisdom about fair-weather friends.",
    context: "social",
  },
  {
    awadhi: "Chhota muh, badi baat",
    literal: "Small mouth, big talk.",
    meaning: "Hierarchical reprimand for speaking above one's station.",
    context: "social",
  },
  {
    awadhi: "Jaisa karoge, waisa bharoge",
    literal: "As you do, so shall you receive.",
    meaning: "Foundational expression of karmic justice.",
    context: "spirituality",
  },
  {
